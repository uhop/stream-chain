// Same as asStream-exec.js, but drives the PROMOTED executor `next` from
// `src/exec.js` (not the bench prototype). Used by node-src.js to confirm the
// src/ module preserves the prototype's measured perf before step 2 wires it in
// for real.
